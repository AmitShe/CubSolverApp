...
public class robot_solver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_robot_solver);
...
//    textDeviceName = (TextView) findViewById(R.id.textdevicename);
    ...
    private void connectUsb() {
        ...
        Toast.makeText(robot_solver.this, "connectUsb()", Toast.LENGTH_LONG)
                .show();
    ...
    private void releaseUsb() {
        ...
        Toast.makeText(robot_solver.this, "releaseUsb()", Toast.LENGTH_LONG)
                .show();
    ...
    private void searchEndPoint() {
        ...
        if (deviceFound == null) {
            Toast.makeText(robot_solver.this, "device not found",
                    Toast.LENGTH_LONG).show();
    ...
    */
            ...
            Toast.makeText(robot_solver.this, "Permission: " + permitToRead,
                    Toast.LENGTH_LONG).show();
    ...
    private final BroadcastReceiver mUsbReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ACTION_USB_PERMISSION.equals(action)) {
                ...
                Toast.makeText(robot_solver.this, "ACTION_USB_PERMISSION",
                        Toast.LENGTH_LONG).show();
